...
const Kontakt: NextPage<{ success?: boolean }> = ({ success }) => {
  return (
    <>
      <NextSeo
        title="Kontakt - Keldrik.com - Programmieren mit Javascript, Node.js, React
            usw..."
        description="Mit dem Kontaktformular kannst du mir eine Nachricht schicken."
        canonical="https://www.keldrik.com/kontakt"
        noindex={true}
      />
      <Layout>
