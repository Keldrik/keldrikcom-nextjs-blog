    ...
    <Layout>
      <div className="pt-6 pb-6">
        ...
        <p className="pt-4">
          ...
          Kontaktdaten des Verantwortlichen 1.1 Wir freuen uns, dass Sie unsere
          Website besuchen und bedanken uns für Ihr Interesse. Im Folgenden
          informieren wir Sie über den Umgang mit Ihren personenbezogenen Daten
          bei der Nutzung unserer Website. Personenbezogene Daten sind hierbei
          alle Daten, mit denen Sie persönlich identifiziert werden können. 1.2
          Verantwortlicher für die Datenverarbeitung auf dieser Website im Sinne
          der Datenschutz-Grundverordnung (DSGVO) ist Thomas Wiegold E-Mail:
          mail@keldrik.com. Der für die Verarbeitung von personenbezogenen Daten
          Verantwortliche ist diejenige natürliche oder juristische Person, die
          allein oder gemeinsam mit anderen über die Zwecke und Mittel der
          Verarbeitung von personenbezogenen Daten entscheidet. 1.3 Diese
        ...
        <p>
          2) Datenerfassung beim Besuch unserer Website Bei der bloß
          ...
          (sog. „Server-Logfiles“). Wenn Sie unsere Website aufrufen, erheben
          wir die folgenden Daten, die für uns technisch erforderlich sind, um
          Ihnen die Website anzuzeigen: - Unsere besuchte Website - Datum und
          ...
          IP-Adresse (ggf.: in anonymisierter Form) Die Verarbeitung erfolgt
          gemäß Art. 6 Abs. 1 lit. f DSGVO auf Basis unseres berechtigten
          Interesses an der Verbesserung der Stabilität und Funktionalität
          unserer Website. Eine Weitergabe oder anderweitige Verwendung der
          Daten findet nicht statt. Wir behalten uns allerdings vor, die
          Server-Logfiles nachträglich zu überprüfen, sollten konkrete
          Anhaltspunkte auf eine rechtswidrige Nutzung hinweisen.
        </p>
        <p>
          3) Cookies Um den Besuch unserer Website attraktiv zu gestalten und
          ...
          werden, erfolgt die Verarbeitung gemäß Art. 6 Abs. 1 lit. b DSGVO zur
          Durchführung des Vertrages, gemäß Art. 6 Abs. 1 lit. a DSGVO im Falle
          einer erteilten Einwilligung oder gemäß Art. 6 Abs. 1 lit. f DSGVO zur
          ...
          effektiven Ausgestaltung des Seitenbesuchs. Bitte beachten Sie, dass
          Sie Ihren Browser so einstellen können, dass Sie über das Setzen von
          ...
          ausschließen können. Jeder Browser unterscheidet sich in der Art, wie
          er die Cookie-Einstellungen verwaltet. Diese ist in dem Hilfemenü
          ...
          jeweiligen Browser unter den folgenden Links: Internet Explorer:
        ...
        <p>
          4) Kontaktaufnahme Im Rahmen der Kontaktaufnahme mit uns (z.B. per
        ...
        <p>
          5) Kommentarfunktion Im Rahmen der Kommentarfunktion auf dieser
          Website werden neben Ihrem Kommentar auch Angaben zum Zeitpunkt der
          Erstellung des Kommentars und der von Ihnen gewählte Kommentatorenname
          gespeichert und auf dieser Website veröffentlicht. Ferner wird Ihre
          IP-Adresse mitprotokolliert und gespeichert. Diese Speicherung der
          ...
          verletzt oder rechtswidrige Inhalte postet. Ihre E-Mailadresse
          benötigen wir, um mit Ihnen in Kontakt zu treten, falls ein Dritter
          Ihren veröffentlichten Inhalt als rechtswidrig beanstanden sollte.
          ...
          wenn sie von Dritten als rechtswidrig beanstandet werden. Die
          Nachfolgekommentare können von Ihnen als Nutzer abonniert werden. Sie
          erhalten hierzu eine Bestätigungs-E-Mail, damit sichergestellt werden
          kann, dass Sie der Inhaber der angegebenen E-Mail-Adresse sind
          (Double-Opt-In-Verfahren). Die Rechtsgrundlage für die
          Datenverarbeitung im Falle der Abonnierung von Kommentaren ist Art. 6
          Abs. 1 lit. a DSGVO. Sie können laufende Kommentarabonnements
          jederzeit mit Wirkung für die Zukunft abbestellen, nähere
          Informationen zur Abbestellmöglichkeit entnehmen Sie bitte der
          Bestätigungs-E-Mail.
        </p>
        <p>
          6) Verwendung von Sozialen Medien: Videos Verwendung von
          Youtube-Videos Diese Website nutzt die Youtube-Einbettungsfunktion zur
          Anzeige und Wiedergabe von Videos des Anbieters „Youtube“, der zu der
          Google Ireland Limited, Gordon House, 4 Barrow St, Dublin, D04 E5W5,
          Irland („Google“) gehört. Hierbei wird der erweiterte Datenschutzmodus
          verwendet, der nach Anbieterangaben eine Speicherung von
          Nutzerinformationen erst bei Wiedergabe des/der Videos in Gang setzt.
          Wird die Wiedergabe eingebetteter Youtube-Videos gestartet, setzt der
          Anbieter „Youtube“ Cookies ein, um Informationen über das
          Nutzerverhalten zu sammeln. Hinweisen von „Youtube“ zufolge dienen
          diese unter anderem dazu, Videostatistiken zu erfassen, die
          Nutzerfreundlichkeit zu verbessern und missbräuchliche Handlungsweisen
          zu unterbinden. Wenn Sie bei Google eingeloggt sind, werden Ihre Daten
          direkt Ihrem Konto zugeordnet, wenn Sie ein Video anklicken. Wenn Sie
          die Zuordnung mit Ihrem Profil bei YouTube nicht wünschen, müssen Sie
          sich vor Aktivierung des Buttons ausloggen. Google speichert Ihre
          Daten (selbst für nicht eingeloggte Nutzer) als Nutzungsprofile und
          wertet diese aus. Eine solche Auswertung erfolgt insbesondere gemäß
          Art. 6 Abs. 1 lit. f DSGVO auf Basis der berechtigten Interessen von
          Google an der Einblendung personalisierter Werbung, Marktforschung
          und/oder bedarfsgerechten Gestaltung seiner Website. Ihnen steht ein
          Widerspruchsrecht zu gegen die Bildung dieser Nutzerprofile, wobei Sie
          sich zur Ausübung dessen an YouTube richten müssen. Im Rahmen der
          ...
          Datenverarbeitungsvorgänge auslösen kann. Für den Fall der
          Übermittlung von personenbezogenen Daten an die Google LLC. mit Sitz
          in den USA, hat sich Google LLC. für das us-europäische
          ...
          https://www.privacyshield.gov/list Weitere Informationen zum
          Datenschutz bei „YouTube“ finden Sie in der Datenschutzerklärung des
          Anbieters unter: https://www.google.de/intl/de/policies/privacy Soweit
        ...
        <p>
          7) Tools und Sonstiges - Adobe Fonts (Typekit) Diese Seite nutzt zur
          einheitlichen Darstellung von Schriftarten so genannte Web Fonts die
          von der Adobe Systems Incorporated, 345 Park Avenue, San Jose, CA
          95110-2704, USA („Adobe“) bereitgestellt werden. Beim Aufruf einer
          Seite lädt Ihr Browser die benötigten Web Fonts in ihren
          Browser-Cache, um Texte und Schriftarten korrekt anzuzeigen. Zu diesem
          Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern
          von Adobe aufnehmen. Hierbei kann es auch zu einer Übermittlung von
          personenbezogenen Daten an die Server von Adobe in den USA kommen. Auf
          diese Weise erlangt Adobe Kenntnis darüber, dass über Ihre IP-Adresse
          unsere Website aufgerufen wurde. Die Nutzung von Adobe Fonts erfolgt
          ...
          den Fall der Übermittlung von personenbezogenen Daten an Adobe mit
          Sitz in den USA, hat sich Adobe für das us-europäische
          Datenschutzübereinkommen „Privacy Shield“ zertifiziert, welches die
          Einhaltung des in der EU geltenden Datenschutzniveaus gewährleistet.
          Ein aktuelles Zertifikat kann hier eingesehen werden:
          https://www.privacyshield.gov/list Weitere Informationen zu Adobe
          Fonts finden Sie unter https://fonts.adobe.com/ und in der
          Datenschutzerklärung von Adobe: https://www.adobe.com/de/privacy.html
          - Google Web Fonts Diese Seite nutzt zur einheitlichen Darstellung von
          Schriftarten so genannte Web Fonts die von der Google Ireland Limited,
          Gordon House, 4 Barrow St, Dublin, D04 E5W5, Irland („Google“)
          bereitgestellt werden. Beim Aufruf einer Seite lädt Ihr Browser die
          benötigten Web Fonts in ihren Browser-Cache, um Texte und Schriftarten
          korrekt anzuzeigen. Zu diesem Zweck muss der von Ihnen verwendete
          Browser Verbindung zu den Servern von Google aufnehmen. Hierbei kann
          es auch zu einer Übermittlung von personenbezogenen Daten an die
          Server der Google LLC. in den USA kommen. Auf diese Weise erlangt
          ...
          Art. 6 Abs. 1 lit. f DSGVO dar. Wenn Ihr Browser Web Fonts nicht
          unterstützt, wird eine Standardschrift von Ihrem Computer genutzt. Für
          den Fall der Übermittlung von personenbezogenen Daten an die Google
          LLC. mit Sitz in den USA, hat sich Google LLC. für das us-europäische
          Datenschutzübereinkommen „Privacy Shield“ zertifiziert, welches die
          Einhaltung des in der EU geltenden Datenschutzniveaus gewährleistet.
          Ein aktuelles Zertifikat kann hier eingesehen werden:
          https://www.privacyshield.gov/list Weitere Informationen zu Google Web
          Fonts finden Sie unter https://developers.google.com/fonts/faq und in
          der Datenschutzerklärung von Google:
          https://www.google.com/policies/privacy/
        </p>
        <p>
          8) Rechte des Betroffenen 9.1 Das geltende Datenschutzrecht gewährt
          Ihnen gegenüber dem Verantwortlichen hinsichtlich der Verarbeitung
          ...
          Verstoßes. 9.2 WIDERSPRUCHSRECHT WENN WIR IM RAHMEN EINER
        ...
        <p>
          9) Dauer der Speicherung personenbezogener Daten Die Dauer der
          Speicherung von personenbezogenen Daten bemisst sich anhand der
          jeweiligen Rechtsgrundlage, am Verarbeitungszweck und – sofern
